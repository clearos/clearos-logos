...
License: Copyright © 2014 ClearFoundation, LTD.  All rights reserved.
...
ClearOS Project to replace the Red Hat "Shadow Man" logo and  RPM logo.
The Red Hat "Shadow Man" logo, RPM, and the RPM logo are trademarks or
registered trademarks of Red Hat, Inc.

The Package and ClearOS logos (the "Marks") can only used as outlined
in the included COPYING file. Please see that file for information on
copying and redistribution of the ClearOS Marks.
...
cp -rp kde-splash/ClearOS7/ $RPM_BUILD_ROOT%{_kde4_appsdir}/ksplash/Themes/
pushd $RPM_BUILD_ROOT%{_kde4_appsdir}/ksplash/Themes/ClearOS7/2560x1600/
...
cp -rp kde-kdm/ClearOS7/ $RPM_BUILD_ROOT/%{_kde4_appsdir}/kdm/themes/
pushd $RPM_BUILD_ROOT/%{_kde4_appsdir}/kdm/themes/ClearOS7/
...
%{_kde4_appsdir}/ksplash/Themes/ClearOS7/
%{_kde4_appsdir}/kdm/themes/ClearOS7/
%{_kde4_datadir}/wallpapers/ClearOS7/
%{_kde4_appsdir}/desktoptheme/ClearOS7/
...
%changelog
* Fri Oct 17 2014 Shad L. Lords <slords@clearcenter.com>
- package created
